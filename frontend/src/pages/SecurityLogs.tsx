      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button className="gradient-hero text-primary-foreground">
              <Shield className="h-4 w-4 mr-2" /> Verify Full Chain
            </Button>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <Input placeholder="Search by Node ID, Action or Hash..." className="pl-10" />
          </div>
          <Button variant="outline"><Calendar className="h-4 w-4 mr-2" /> Oct 12 - Oct 19</Button>
        ...
        <div className="gradient-accent rounded-2xl p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <Button variant="outline" className="border-accent-foreground/30 text-accent-foreground bg-accent-foreground/10 hover:bg-accent-foreground/20 shrink-0">
            <RefreshCw className="h-4 w-4 mr-2" /> Run Manual Audit
          </Button>
        </div>
        ...
        <div className="flex justify-start">
          <Button variant="destructive" className="gap-2">
            <Lock className="h-4 w-4" /> Emergency Lockout
          </Button>
        </div>
      </div>
    </DashboardLayout>
